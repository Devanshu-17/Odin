...
def add_bg_from_url():
    st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("https://raw.githubusercontent.com/Devanshu-17/odin_testing/main/stellar-collision-by-kuldar-leement-wallpaper.jpeg?token=GHSAT0AAAAAAB6TL3P6NUYVDHIKZZZUEPHAY7TD5JA");
...
def add_logo():
    ...
    headers = {
        "Authorization": "token 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"
    }
